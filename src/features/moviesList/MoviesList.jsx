import { List, Row, Col, Typography, Image, Rate } from "antd";
...
const MovieListItem = ({ item }) => {
  ...
  return (
    <div className="MovieListItem">
      <Row>
        <Col>
          <Title level={3}>{original_title}</Title>
        </Col>
        <Col className="MovieListItem-vote">
          <Rate
            allowHalf
            value={vote_average / 2}
            className="MovieListItem-vote-rate"
          />
          {vote_average + "/10"}
        </Col>
      </Row>
